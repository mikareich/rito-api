  ...
  return (
    <div className="w-[70%] h-[100%] flex flex-col gap-3 items-center text-white p-3">
      <input
        ...
        className="outline-none border-none bg-gray-700 p-3 rounded-lg w-[100%]"
      ...
      <div className="w-[100%] h-[100%] gap-3 rounded-lg relative justify-center flex flex-wrap overflow-y-scroll">
        {skins
          ...
          .map((skin) => {
            return (
              <div className="bg-gray-800 w-[100%] rounded-lg p-3 gap-3 relative flex flex-col items-center justify-center flex-grow">
                <img src={skin?.displayIcon} className="w-[100%]" />
                <p className="NoDrag mt-auto">{skin?.displayName}</p>
                <button
                  className="bg-gray-700 rounded-lg p-3 hover:bg-gray-600 transition-all duration-100 ease-linear w-[100%] NoDrag"
                  onClick={() => {
                    equipSkin(skin?.uuid, skin?.displayName);
                  }}
                >
                  Equip
                </button>
